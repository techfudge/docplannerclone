...
function scrollToY(t, e, i, n) {
    function o() {
        ...
        window.scrollTo(0, s + (t - s) * d)) : (n && n(),
        window.scrollTo(0, t))
    }
    "object" == typeof t && (t = t.offset().top);
    var s = window.scrollY || window.pageYOffset
      , t = t || 0
      , e = e || 2e3
      , i = i || "easeOutSine"
      , r = 0
      , a = Math.max(.1, Math.min(Math.abs(s - t) / e, .8))
      , l = (Math.PI,
    {
    ...
    function e(i) {
        function n(e, o, s) {
            ...
            if ("undefined" != typeof document) {
                ...
                e || (r = {});
                for (var l = document.cookie ? document.cookie.split("; ") : [], d = /(%[0-9A-Z]{2})+/g, c = 0; c < l.length; c++) {
                    var u = l[c].split("=")
                      , h = u.slice(1).join("=");
                    '"' === h.charAt(0) && (h = h.slice(1, -1));
                    try {
                        var p = u[0].replace(d, decodeURIComponent);
                        if (h = i.read ? i.read(h, p) : i(h, p) || h.replace(d, decodeURIComponent),
                        this.json)
                            try {
                                h = JSON.parse(h)
                            } catch (t) {}
...
function(t) {
    function e(t) {
        for (var e = (t += "").split("."), i = e[0], n = e.length > 1 ? "." + e[1] : "", o = /(\d+)(\d{3})/; o.test(i); )
            i = i.replace(o, "$1 $2");
        return i + n
    }
    t.fn.counterUp = function(i) {
        var n = t.extend({
            time: 400,
            delay: 10
        }, i);
        return this.each(function() {
            ...
            !function() {
                ...
                s = s.replace(/,/g, ""),
                /^[0-9]+$/.test(s);
                for (var a = /^[0-9]+\.[0-9]+$/.test(s), l = a ? (s.split(".")[1] || []).length : 0, d = n; d >= 1; d--) {
                    var c = parseInt(s / n * d);
                    if (a && (c = parseFloat(s / n * d).toFixed(l)),
                    r)
                ...
                i.data("counterup-func", function() {
                    i.text(e(i.data("counterup-nums").shift())),
                    i.data("counterup-nums").length ? setTimeout(i.data("counterup-func"), o.delay) : (i.data("counterup-nums"),
                    i.data("counterup-nums", null),
                    i.data("counterup-func", null))
                }),
                setTimeout(i.data("counterup-func"), o.delay)
            }()
        })
    }
}(jQuery);
var isMobile = navigator.userAgent.match(/Android|AvantGo|BlackBerry|DoCoMo|Fennec|iPod|iPhone|iPad|J2ME|MIDP|NetFront|Nokia|Opera Mini|Opera Mobi|PalmOS|PalmSource|portalmmm|Plucker|ReqwirelessWeb|SonyEricsson|Symbian|UP\\.Browser|webOS|Windows CE|Windows Phone OS|Xiino/i)
  , cssProp = function(t) {
    var e = document.body
      , i = !1
      , n = getComputedStyle(e, null)
      , o = ["webkit", "Webkit", "Moz", "moz", "Ms", "ms", "O", "o", ""]
      , s = o.length
      , r = t;
    if (!i) {
        for (var a = 0; a < s; a++)
            if ("" == o[a] && (r = r.toLowerCase()),
            void 0 != n[o[a] + r])
                return o[a] + r;
        i = !0
    }
...
function(t, e, i) {
    ...
    var e = function(e, i, n) {
        var o = {
            ...
            getCaret: function() {
                try {
                    var t, i = 0, n = e.get(0), s = document.selection, r = n.selectionStart;
                    return s && -1 === navigator.appVersion.indexOf("MSIE 10") ? ((t = s.createRange()).moveStart("character", -o.val().length),
                    i = t.text.length) : (r || "0" === r) && (i = r),
                    i
                } catch (t) {}
            },
            setCaret: function(t) {
            ...
            getRegexMask: function() {
                for (var t, e, n, o, s = [], a = 0; a < i.length; a++)
                    (t = r.translation[i.charAt(a)]) ? (e = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""),
                    n = t.optional,
                    (t = t.recursive) ? (s.push(i.charAt(a)),
                    o = {
                        digit: i.charAt(a),
                        pattern: e
                    }) : s.push(n || t ? e + "?" : e)) : s.push(i.charAt(a).replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
                return s = s.join(""),
            ...
            val: function(t) {
                ...
                return 0 < arguments.length ? (e[i]() !== t && e[i](t),
                i = e) : i = e[i](),
                i
            },
            calculateCaretPosition: function() {
                var t = e.data("mask-previus-value") || ""
                  ...
                  , n = o.getCaret();
                if (t !== i) {
                    var s, r = e.data("mask-previus-caret-pos") || 0, i = i.length, a = t.length, l = t = 0, d = 0, c = 0;
                    for (s = n; s < i && o.maskDigitPosMap[s]; s++)
                        l++;
                    for (s = n - 1; 0 <= s && o.maskDigitPosMap[s]; s--)
                        t++;
                    for (s = n - 1; 0 <= s; s--)
                        o.maskDigitPosMap[s] && d++;
                    for (s = r - 1; 0 <= s; s--)
                        o.maskDigitPosMapOld[s] && c++;
                    n > a ? n = i : r >= n && r !== a ? o.maskDigitPosMapOld[n] || (r = n,
                    n = n - (c - d) - t,
                    o.maskDigitPosMap[n] && (n = r)) : n > r && (n = n + (d - c) + l)
                }
                return n
            },
            ...
            getMasked: function(t, e) {
                var s, a, l = [], d = void 0 === e ? o.val() : e + "", c = 0, u = i.length, h = 0, p = d.length, f = 1, m = "push", g = -1, v = 0, y = [];
                n.reverse ? (m = "unshift",
                f = -1,
                s = 0,
                c = u - 1,
                ...
                for (var w; a(); ) {
                    var b = i.charAt(c)
                      , k = d.charAt(h)
                      , S = r.translation[b];
                    S ? (k.match(S.pattern) ? (l[m](k),
                    S.recursive && (-1 === g ? g = c : c === s && (c = g - f),
                    s === g && (c -= f)),
                    c += f) : k === w ? (v--,
                    w = void 0) : S.optional ? (c += f,
                    h -= f) : S.fallback ? (l[m](S.fallback),
                    c += f,
                    h -= f) : o.invalid.push({
                        p: h,
                        v: k,
                ...
                return d = i.charAt(s),
                u !== p + 1 || r.translation[d] || l.push(d),
                l = l.join(""),
                o.mapMaskdigitPositions(l, y, p),
                l
            },
            mapMaskdigitPositions: function(t, e, i) {
                for (t = n.reverse ? t.length - i : 0,
                o.maskDigitPosMap = {},
                i = 0; i < e.length; i++)
                    o.maskDigitPosMap[e[i] + t] = 1
            },
            callbacks: function(t) {
                ...
                d("onChange", !0 === r, l),
                d("onKeyPress", !0 === r, l),
                d("onComplete", s.length === i.length, l),
                d("onInvalid", 0 < o.invalid.length, [s, t, e, o.invalid, n])
            }
        };
        e = t(e);
        ...
        r.init = function(a) {
            ...
            r.translation = t.extend({}, t.jMaskGlobals.translation, n.translation),
            r = t.extend(!0, {}, r, n),
            s = o.getRegexMask(),
            a)
                o.events(),
                ...
                for (var l = !0; a < i.length; a++) {
                    var d = r.translation[i.charAt(a)];
                    if (d && d.recursive) {
                        l = !1;
                        break
                    }
                }
                l && e.attr("maxlength", i.length),
                o.destroyEvents(),
                o.events(),
                a = o.getCaret(),
                o.val(o.getMasked()),
    ...
    var i = function() {
        var i = t(this)
          , o = {}
          , s = i.attr("data-mask");
        if (i.attr("data-mask-reverse") && (o.reverse = !0),
        i.attr("data-mask-clearifnotmatch") && (o.clearIfNotMatch = !0),
        "true" === i.attr("data-mask-selectonfocus") && (o.selectOnFocus = !0),
        n(i, s, o))
            return i.data("mask", new e(this,s,o))
    }
      , n = function(e, i, n) {
        n = n || {};
        var o = t(e).data("mask")
        ...
        try {
            ...
            "object" != typeof o || s(o.options) !== s(n) || o.mask !== i
        } catch (t) {}
    }
      , o = function(t) {
        var e, i = document.createElement("div");
        return t = "on" + t,
        (e = t in i) || (i.setAttribute(t, "return;"),
    ...
    t.fn.mask = function(i, o) {
        ...
        s && "" !== s && a && (clearInterval(t.maskWatchers[s]),
    ...
    t.extend(t.validator, {
        ...
        prototype: {
            ...
            elementValue: function(e) {
                ...
                return "radio" === o || "checkbox" === o ? t("input[name='" + e.name + "']:checked").val() : "number" === o && void 0 !== e.validity ? !e.validity.badInput && n.val() : "string" == typeof (i = n.val()) ? i.replace(/\r/g, "") : i
            },
            check: function(e) {
                e = this.validationTargetFor(this.clean(e));
                var i, n, o, s = t(e).rules(), r = t.map(s, function(t, e) {
                    return e
                ...
                for (n in s) {
                    ...
                    try {
                        if ("dependency-mismatch" === (i = t.validator.methods[n].call(this, l, e, o.parameters)) && 1 === r) {
                            a = !0;
                            continue
                        }
                        if (a = !1,
            ...
            showLabel: function(e, i) {
                var n, o, s, r = this.errorsFor(e), a = this.idOrName(e), l = t(e).attr("aria-describedby");
                ...
                (o = this.groups[e.name]) && t.each(this.groups, function(e, i) {
                    i === o && t("[name='" + e + "']", this.currentForm).attr("aria-describedby", r.attr("id"))
                }))),
        ...
        attributeRules: function(e) {
            var i, n, o = {}, s = t(e), r = e.getAttribute("type");
        ...
        dataRules: function(e) {
            var i, n, o = {}, s = t(e);
            for (i in t.validator.methods)
                void 0 !== (n = s.data("rule" + i.charAt(0).toUpperCase() + i.substring(1).toLowerCase())) && (o[i] = n);
            return o
        },
            ...
            remote: function(e, i, n) {
                ...
                t.ajax(t.extend(!0, {
                    ...
                    success: function(n) {
                        ...
                        s[i.name] = r.message = t.isFunction(a) ? a(e) : a,
                        o.invalid[i.name] = !0,
                        o.showErrors(s)),
                        r.valid = d,
                        o.stopRequest(i, d)
    ...
    e.prototype.refresh = function() {
        ...
        for (var s in t) {
            ...
            for (var a in this.waypoints[s]) {
                var l, d, c, u, h, p = this.waypoints[s][a], f = p.options.offset, m = p.triggerPoint, g = 0, v = null == m;
                ...
                u = d && c,
                h = !d && !c,
                !v && u ? (p.queueTrigger(r.backward),
                n[p.group.id] = p.group) : !v && h ? (p.queueTrigger(r.forward),
...
function(t, e) {
    ...
    var easeInOutQuad = function(t, e, i, n) {
        return (t /= n / 2) < 1 ? i / 2 * t * t + e : (t--,
        -i / 2 * (t * (t - 2) - 1) + e)
    }
    ...
    return function() {
        ...
        function i(t) {
            return t.getBoundingClientRect().top + r
        }
        function n(t) {
            p || (p = t),
            m = d(f = t - p, r, u, h),
            window.scrollTo(0, m),
            f < h ? window.requestAnimationFrame(n) : o()
        }
        function o() {
            window.scrollTo(0, r + u),
            s && c && (s.setAttribute("tabindex", "-1"),
            s.focus()),
            "function" == typeof g && g(),
            p = !1
        }
        ...
        return function(o) {
            ...
            switch (h = p.duration || 1e3,
            l = p.offset || 0,
            g = p.callback,
            d = p.easing || easeInOutQuad,
            c = p.a11y || !1,
            r = e(),
...
function(t, e) {
    ...
    function i(i, s, a) {
        ...
        a.fn[i] = function(t) {
            return "string" == typeof t ? l(this, t, o.call(arguments, 1)) : (d(this, t),
            this)
        }
        ,
        n(a))
...
function(t, e) {
    ...
    function o(o) {
        ...
        o && "object" == typeof o && o.nodeType) {
            ...
            if ("none" == r.display)
                return e();
            var d = {};
            d.width = o.offsetWidth,
            d.height = o.offsetHeight;
            for (var c = d.isBorderBox = "border-box" == r.boxSizing, u = 0; l > u; u++) {
                var h = a[u]
                  , p = r[h]
                  , f = parseFloat(p);
                d[h] = isNaN(f) ? 0 : f
            ...
            var m = d.paddingLeft + d.paddingRight
              ...
              , k = c && s
              , S = t(r.width);
            !1 !== S && (d.width = S + (k ? 0 : m + w));
            var T = t(r.height);
            return !1 !== T && (d.height = T + (k ? 0 : g + b)),
    ...
    var s, r = "undefined" == typeof console ? function() {}
    : function(t) {}
    , a = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], l = a.length, d = !1;
    return o
}),
function(t, e) {
...
function(t, e) {
    ...
    n._getItemLayoutPosition = function(t) {
        ...
        for (var o = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](n, t), s = {
            ...
            y: o.y
        }, r = o.y + t.size.outerHeight, a = n + o.col, l = o.col; a > l; l++)
            this.colYs[l] = r;
        return s
    }
    ,
    ...
    n._manageStamp = function(t) {
        ...
        for (var l = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, d = r; a >= d; d++)
...
function(t, e, i) {
    function n(i) {
        ...
        (lt = !1 !== i.forceHeight) && (Ot = i.scale || 1),
        ct = i.mobileDeceleration || T,
        ht = !1 !== i.smoothScrolling,
        pt = i.smoothScrollingDuration || C,
        ft = {
            targetTop: ot.getScrollTop()
        },
        (_t = (i.mobileCheck || function() {
            return /Android|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent || navigator.vendor || t.opera)
        }
        )()) ? ((rt = e.getElementById(i.skrollrBody || x)) && nt(),
        U(),
        Et(o, [y, k], [w])) : Et(o, [y, b], [w]),
        ot.refresh(),
        wt(t, "resize orientationchange", function() {
            var t = o.clientWidth
              , e = o.clientHeight;
            (e !== jt || t !== Rt) && (jt = e,
            Rt = t,
    ...
    var o, s, r = {
        ...
        VERSION: "0.6.30"
    }, a = Object.prototype.hasOwnProperty, l = t.Math, d = t.getComputedStyle, c = "touchstart", u = "touchmove", h = "touchcancel", p = "touchend", f = "skrollable", m = f + "-before", g = f + "-between", v = f + "-after", y = "skrollr", w = "no-" + y, b = y + "-desktop", k = y + "-mobile", S = "linear", T = .004, x = "skrollr-body", C = 200, A = "center", E = "bottom", $ = "___skrollable_id", F = /^(?:input|textarea|button|select)$/i, z = /^\s+|\s+$/g, P = /^data(?:-(_\w+))?(?:-?(-?\d*\.?\d+p?))?(?:-?(start|end|top|center|bottom))?(?:-?(top|center|bottom))?$/, M = /\s*(@?[\w\-\[\]]+)\s*:\s*(.+?)\s*(?:;|$)/gi, O = /^(@?[a-z\-]+)\[(\w+)\]$/, I = /-([a-z0-9_])/g, L = function(t, e) {
        return e.toUpperCase()
    }, D = /[\-+]?[\d]*\.?[\d]+/g, R = /\{\?\}/g, j = /rgba?\(\s*-?\d+\s*,\s*-?\d+\s*,\s*-?\d+/g, H = /[a-z\-]+-gradient/g, W = "", _ = "", q = function() {
        var t = /^(?:O|Moz|webkit|ms)|(?:-(?:o|moz|webkit|ms)-)/;
        if (d) {
            var e = d(s, null);
            for (var i in e)
                if (W = i.match(t) || +i == i && e[i].match(t))
                    break;
            if (!W)
                return void (W = _ = "");
            "-" === (W = W[0]).slice(0, 1) ? (_ = W,
                                ...
                                if ("data-emit-events" !== m.name) {
                                    ...
                                    if (null !== g) {
                                        var v = {
                                            props: m.value,
                                            element: r,
                                            eventType: m.name.replace(I, L)
                                        };
                                        l.push(v);
                                        var y = g[1];
                                        y && (v.constant = y.substr(1));
                                        var w = g[2];
                                        /p$/.test(w) ? (v.isPercentage = !0,
                                        v.offset = (0 | w.slice(0, -1)) / 100) : v.offset = 0 | w;
                                        var b = g[3]
                                          , k = g[4] || b;
                                        b && "start" !== b && "end" !== b ? (v.mode = "relative",
                                        v.anchors = [b, k]) : (v.mode = "absolute",
                                        "end" === b ? v.isEnd = !0 : v.isPercentage || (v.offset = v.offset * Ot))
                                    }
                                } else
                                    u = !0;
                            else
    ...
    n.prototype.relativeToAbsolute = function(t, e, i) {
        var n = o.clientHeight
          ...
          , r = s.top
          , a = s.bottom - s.top;
        return e === E ? r -= n : e === A && (r -= n / 2),
        i === E ? r += a : i === A && (r += a / 2),
        (r += ot.getScrollTop()) + .5 | 0
    }
    ,
    n.prototype.animateTo = function(t, e) {
        ...
        }).topDiff || (ut.done && ut.done.call(ot, !1),
        ut = i),
        ot
    }
    ,
    n.prototype.stopAnimateTo = function() {
        ut && ut.done && ut.done.call(ot, !0),
        ut = i
    }
    ,
    ...
    n.prototype.setScrollTop = function(e, i) {
        return mt = !0 === i,
        _t ? qt = l.min(l.max(e, 0), Mt) : t.scrollTo(0, e),
        ot
    }
    ,
    n.prototype.getScrollTop = function() {
        return _t ? qt : t.pageYOffset || o.scrollTop || s.scrollTop || 0
    }
    ,
    ...
    ;
    var U = function() {
        var n, r, a, d, f, m, g, v, y, w, b, k;
        wt(o, [c, u, h, p].join(" "), function(t) {
            var o = t.changedTouches[0];
            for (d = t.target; 3 === d.nodeType; )
                d = d.parentNode;
            switch (f = o.clientY,
            m = o.clientX,
            w = t.timeStamp,
            F.test(d.tagName) || t.preventDefault(),
            t.type) {
            case c:
                n && n.blur(),
                ot.stopAnimateTo(),
                ...
                break;
            case u:
                F.test(d.tagName) && e.activeElement !== d && t.preventDefault(),
                v = f - g,
                k = w - b,
                ot.setScrollTop(qt - v, !0),
                g = f,
                b = w;
                break;
            default:
      ...
      , G = function() {
        var t, e, i, n, s, r, a, d, c, u, h, p = o.clientHeight, f = xt();
        for (d = 0,
        c = st.length; c > d; d++)
            for (t = st[d],
            e = t.element,
            ...
            r = n.length; r > s; s++)
                ...
                a.frame = ot.relativeToAbsolute(i, a.anchors[0], a.anchors[1]) - u,
                it(e, !0)),
                a.frame += h,
                lt && !a.isEnd && a.frame > Mt && (Mt = a.frame);
        for (Mt = l.max(Mt, Ct()),
        d = 0,
        c = st.length; c > d; d++) {
            for (s = 0,
            r = (n = (t = st[d]).keyFrames).length; r > s; s++)
                a = n[s],
                h = f[a.constant] || 0,
                a.isEnd && (a.frame = Mt - a.offset + h);
            t.keyFrames.sort(Pt)
        }
    }
      , Y = function(t, e) {
        for (var i = 0, n = st.length; n > i; i++) {
            var o, s, l = st[i], d = l.element, c = l.smoothScrolling ? t : e, u = l.keyFrames, h = u.length, p = u[0], y = u[u.length - 1], w = c < p.frame, b = c > y.frame, k = w ? p : y, S = l.emitEvents, T = l.lastFrameIndex;
            if (w || b) {
                if (w && -1 === l.edge || b && 1 === l.edge)
                    continue;
                switch (w ? (Et(d, [m], [v, g]),
                S && T > -1 && (St(d, p.eventType, It),
                l.lastFrameIndex = -1)) : (Et(d, [v], [m, g]),
                S && h > T && (St(d, y.eventType, It),
                l.lastFrameIndex = h)),
                l.edge = w ? -1 : 1,
                l.edgeStrategy) {
                case "reset":
                ...
                case "set":
                    var x = k.props;
                    for (o in x)
                        a.call(x, o) && (s = et(x[o].value),
                        0 === o.indexOf("@") ? d.setAttribute(o.substr(1), s) : r.setStyle(d, o, s));
                    continue
                }
            } else
                0 !== l.edge && (Et(d, [f, g], [m, v]),
                l.edge = 0);
            for (var C = 0; h - 1 > C; C++)
                if (c >= u[C].frame && c <= u[C + 1].frame) {
                    ...
                    for (o in A.props)
                        if (a.call(A.props, o)) {
                            var $ = (c - A.frame) / (E.frame - A.frame);
                            $ = A.props[o].easing($),
                            s = tt(A.props[o].value, E.props[o].value, $),
                            s = et(s),
                            0 === o.indexOf("@") ? d.setAttribute(o.substr(1), s) : r.setStyle(d, o, s)
                        }
                    S && T !== C && ("down" === It ? St(d, A.eventType, It) : St(d, E.eventType, It),
                    l.lastFrameIndex = C);
                    break
                }
        }
      ...
      , Q = function() {
        Ht && (Ht = !1,
        Tt());
        var t, e, n = ot.getScrollTop(), o = zt();
        if (ut ? (o >= ut.endTime ? (n = ut.targetTop,
        t = ut.done,
        ut = i) : (e = ut.easing((o - ut.startTime) / ut.duration),
        n = ut.startTop + e * ut.topDiff | 0),
        ot.setScrollTop(n, !0)) : mt || (ft.targetTop - n && (ft = {
            startTop: Lt,
            topDiff: n - Lt,
            targetTop: n,
            startTime: Dt,
        ...
        o <= ft.endTime && (e = V.sqrt((o - ft.startTime) / pt),
        n = ft.startTop + e * ft.topDiff | 0)),
        mt || Lt !== n) {
            mt = !1;
            var s = {
                curTop: n,
                lastTop: Lt,
                maxTop: Mt,
                direction: It = n > Lt ? "down" : Lt > n ? "up" : It
            };
            !1 !== (at.beforerender && at.beforerender.call(ot, s)) && (Y(n, ot.getScrollTop()),
            _t && rt && r.setStyle(rt, "transform", "translate(0, " + -qt + "px) " + vt),
            Lt = n,
            at.render && at.render.call(ot, s)),
            t && t.call(ot, !1)
        }
        Dt = o
    }
      , X = function(t) {
        for (var e = 0, i = t.keyFrames.length; i > e; e++) {
            for (var n, o, s, r, a = t.keyFrames[e], l = {}; null !== (r = M.exec(a.props)); )
                s = r[1],
                o = r[2],
                null !== (n = s.match(O)) ? (s = n[1],
                n = n[2]) : n = S,
      ...
      , it = function(t, e) {
        for (var i, n, o = 0, s = (t = [].concat(t)).length; s > o; o++)
            n = t[o],
            (i = st[n[$]]) && (e ? (n.style.cssText = i.dirtyStyleAttr,
            Et(n, i.dirtyClassAttr)) : (i.dirtyStyleAttr = n.style.cssText,
            i.dirtyClassAttr = At(n),
    ...
    r.setStyle = function(t, e, i) {
        var n = t.style;
        if ("zIndex" === (e = e.replace(I, L).replace("-", "")))
            isNaN(i) ? n[e] = i : n[e] = "" + (0 | i);
        else if ("float" === e)
            n.styleFloat = n.cssFloat = i;
        else
            try {
                W && (n[W + e.slice(0, 1).toUpperCase() + e.slice(1)] = i),
                n[e] = i
            } catch (t) {}
    }
    ;
    var ot, st, rt, at, lt, dt, ct, ut, ht, pt, ft, mt, gt, vt, yt, wt = r.addEvent = function(e, i, n) {
        for (var o, s = 0, r = (i = i.split(" ")).length; r > s; s++)
            o = i[s],
    ...
    , bt = r.removeEvent = function(t, e, i) {
        for (var n = 0, o = (e = e.split(" ")).length; o > n; n++)
            t.removeEventListener ? t.removeEventListener(e[n], i, !1) : t.detachEvent("on" + e[n], i)
    }
    , kt = function() {
        for (var t, e = 0, i = Nt.length; i > e; e++)
            t = Nt[e],
            bt(t.element, t.name, t.listener);
        Nt = []
    }, St = function(t, e, i) {
        at.keyframe && at.keyframe.call(ot, t, e, i)
    }, Tt = function() {
        var t = ot.getScrollTop();
        Mt = 0,
        lt && !_t && (s.style.height = ""),
        G(),
        lt && !_t && (s.style.height = Mt + o.clientHeight + "px"),
        _t ? ot.setScrollTop(l.min(ot.getScrollTop(), Mt)) : ot.setScrollTop(t, !0),
        mt = !0
    }, xt = function() {
        var t, e, i = o.clientHeight, n = {};
        for (t in dt)
            "function" == typeof (e = dt[t]) ? e = e.call(ot) : /p$/.test(e) && (e = e.slice(0, -1) / 100 * i),
            n[t] = e;
        return n
    }, Ct = function() {
        var t = 0;
        return rt && (t = l.max(rt.offsetHeight, rt.scrollHeight)),
        l.max(t, s.scrollHeight, s.offsetHeight, o.scrollHeight, o.offsetHeight, o.clientHeight) - o.clientHeight
    }, At = function(e) {
        var i = "className";
        ...
        var s = "className";
        if (t.SVGElement && e instanceof t.SVGElement && (e = e[s],
        s = "baseVal"),
        o !== i) {
            for (var r = e[s], a = 0, l = o.length; l > a; a++)
                r = Ft(r).replace(Ft(o[a]), " ");
            r = $t(r);
            for (var d = 0, c = n.length; c > d; d++)
                -1 === Ft(r).indexOf(Ft(n[d])) && (r += " " + n[d]);
            e[s] = $t(r)
        } else
            e[s] = n
    }, $t = function(t) {
    ...
    }, Mt = 0, Ot = 1, It = "down", Lt = -1, Dt = zt(), Rt = 0, jt = 0, Ht = !1, Wt = 0, _t = !1, qt = 0, Nt = [];
...
function(t) {
    ...
    e.prototype.getSlideCount = function() {
        ...
        !0 === n.options.swipeToSlide ? (n.$slideTrack.find(".slick-slide").each(function(o, s) {
            return s.offsetLeft - i + t(s).outerWidth() / 2 > -1 * n.swipeLeft ? (e = s,
            !1) : void 0
        }),
    ...
    e.prototype.lazyLoad = function() {
        ...
        var i, n, o, s = this;
        !0 === s.options.centerMode ? !0 === s.options.infinite ? (n = s.currentSlide + (s.options.slidesToShow / 2 + 1),
        o = n + s.options.slidesToShow + 2) : (n = Math.max(0, s.currentSlide - (s.options.slidesToShow / 2 + 1)),
        ...
        o <= s.slideCount && o++)),
        e(s.$slider.find(".slick-slide").slice(n, o)),
    ...
    e.prototype.slideHandler = function(t, e, i) {
        ...
        return e = e || !1,
        !0 === d.animating && !0 === d.options.waitForAnimate || !0 === d.options.fade && d.currentSlide === t || d.slideCount <= d.options.slidesToShow ? void 0 : (!1 === e && d.asNavFor(t),
        n = t,
        l = d.getLeft(n),
        r = d.getLeft(d.currentSlide),
        d.currentLeft = null === d.swipeLeft ? r : d.swipeLeft,
        !1 === d.options.infinite && !1 === d.options.centerMode && (0 > t || t > d.getDotCount() * d.options.slidesToScroll) ? void (!1 === d.options.fade && (n = d.currentSlide,
        !0 !== i ? d.animateSlide(r, function() {
            d.postSlide(n)
        }) : d.postSlide(n))) : !1 === d.options.infinite && !0 === d.options.centerMode && (0 > t || t > d.slideCount - d.options.slidesToScroll) ? void (!1 === d.options.fade && (n = d.currentSlide,
        !0 !== i ? d.animateSlide(r, function() {
            d.postSlide(n)
        ...
        d.updateDots(),
        d.updateArrows(),
        !0 === d.options.fade ? (!0 !== i ? (d.fadeSlideOut(s),
...
function() {
    ...
    t.prototype.scan = function(t) {
        for (var e, i, n, o, s = t.querySelectorAll(this.TYPES.join(",")), r = 0; r < s.length; r++)
            i = s[r],
            e = this[i.tagName.toLowerCase() + "ToPath"],
            n = e(this.parseAttr(i.attributes)),
            o = this.pathMaker(i, n),
    ...
    t.prototype.polylineToPath = function(t) {
        var e, i, n = {}, o = t.points.trim().split(" ");
    ...
    t.prototype.ellipseToPath = function(t) {
        var e = {}
          ...
          , d = s;
        return e.d = "M" + r + "," + a + "A" + i + "," + n + " 0,1,1 " + l + "," + d + "A" + i + "," + n + " 0,1,1 " + r + "," + d,
        e
    }
    ,
    t.prototype.circleToPath = function(t) {
        var e = {}
          ...
          , l = o;
        return e.d = "M" + s + "," + r + "A" + i + "," + i + " 0,1,1 " + a + "," + l + "A" + i + "," + i + " 0,1,1 " + s + "," + l,
        e
    }
    ,
    t.prototype.pathMaker = function(t, e) {
        var i, n, o = document.createElementNS("http://www.w3.org/2000/svg", "path");
    ...
    e.prototype.setElement = function(t, e) {
        ...
        case window.HTMLObjectElement:
            ...
            (n = function(e) {
                if (!o.isReady) {
                    if (o.el = t.contentDocument && t.contentDocument.querySelector("svg"),
                    !o.el && e)
                        throw new Error("Vivus [constructor]: object loaded does not contain any SVG");
                    return o.el ? (t.getAttribute("built-by-vivus") && (o.parentEl.insertBefore(o.el, t),
                    o.parentEl.removeChild(t),
    ...
    e.prototype.mapping = function() {
        ...
        t = 0; t < e.length; t++)
            ...
            isNaN(o.length) ? window.console && console.warn : (this.map.push(o),
    ...
    e.prototype.stop = function() {
        return this.handle && (o(this.handle),
        this.handle = null),
        this
    }
    ,
    ...
    ,
    i = function() {
        e.prototype.docElem || (e.prototype.docElem = window.document.documentElement,
        ...
        ,
        o = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || window.msCancelAnimationFrame || function(t) {
